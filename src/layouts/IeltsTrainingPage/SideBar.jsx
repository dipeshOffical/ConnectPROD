        ...
        <div className="lg:col-span-2 text-color-black">
            ...
            <div className="light-bg mt-8 p-4">
                ...
                <div>
                    ...
                    <div className="mt-4">
                        <label htmlFor="institute" className="text-sm font-medium">Interested State</label>
                        <div className="w-full mt-2"><DropDown /></div>
                    </div>
                    <div className="mt-4">
                    ...
                    <div className="mt-4">
                        <label htmlFor="institute" className="text-sm font-medium">Service Required</label>
                        <div className="w-full mt-2"><DropDown /></div>
                    </div>
                    <div className="mt-4">
                        <label htmlFor="question" className="text-sm font-medium">Any Question For Us?</label>
                        <div className="mt-2"><textarea className="border border-gray-300 h-40 w-full"></textarea></div>
                    </div>
